...
export class AccountFormComponent implements OnInit {
    ...
    get openedOn() {
        return this.accountForm.get('opened_on') as FormControl;
    }
    get closedOn() {
        return this.accountForm.get('closed_on') as FormControl;
    }
    get note() {
        return this.accountForm.get('note') as FormControl;
    }
    get url() {
        return this.accountForm.get('url') as FormControl;
    }
    get logo_url() {
        return this.accountForm.get('logo_url') as FormControl;
    }
    get existing_logo_action() {
    ...
    populate(account: Account) {
        ...
        if (account.transactionCount === 0) {
            this.deletionConfirmationMessage =
                'Delete this account? No transactions will be affected.';
        }

        if (account.transactionCount === 1) {
            this.deletionConfirmationMessage =
                'Delete this account and 1 transaction associated with it?';
        }
